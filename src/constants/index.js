...
export const ERROR_MESSAGES = {
  ...
  taxIdErrorMessage: 'Please enter VAT / Tax ID',
  streetNameErrorMessage: 'Please enter street name',
  numberErrorMessage: 'Please enter number',
  postcodeErrorMessage: 'Please post code',
